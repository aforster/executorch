...
FRESH = (3, len(BLOB))
NOT_FOUND = urllib.error.HTTPError("https://example/blob", 404, "Not Found", {}, None)
...
class RestoreTest(unittest.TestCase):
    ...
    def test_digest_mismatch_retries_then_fails_and_cleans_up(self):
        with mock.patch.object(
...
class CachedObjectTest(unittest.TestCase):
    def test_age_and_size_from_headers(self):
        ...
        with mock.patch.object(
            ...
            self.assertEqual(CACHE.cached_object("https://example/blob"), (100, 42))
        ...
        for headers in ({}, {"Content-Length": "42"}, {"Last-Modified": "garbage"}):
            with self.subTest(headers=headers):
                with mock.patch.object(
                    ...
                    self.assertIsNone(CACHE.cached_object("https://example/blob"))
